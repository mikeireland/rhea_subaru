...
#define ZABER_DISABLE_AUTO_HOME		    256
#define ZABER_REVERSE_POTENTIOMETER	    512
#define ZABER_CIRCULAR_PHASE		    2048
#define ZABER_DISABLE_POWER_LED		    16384
#define ZABER_DISABLE_SERIAL_LED	    32768
